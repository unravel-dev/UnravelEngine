...
void set_professional_dark_theme()
{
    ...
    auto backgroundDeepest = ImColor(16, 20, 26, 255);
    auto backgroundDeep = ImColor(22, 27, 34, 255);
    auto backgroundMedium = ImColor(32, 39, 49, 255);
    auto backgroundElevated = ImColor(42, 51, 64, 255);
    auto backgroundPopup = ImColor(26, 32, 41, 255);

    auto primaryAccent = ImColor(78, 205, 196, 255);
    auto primaryAccentHover = ImColor(88, 215, 206, 255);
    auto primaryAccentActive = ImColor(68, 185, 176, 255);
    auto primaryAccentMuted = ImColor(78, 205, 196, 80);

    auto secondaryAccent = ImColor(249, 202, 36, 255);
    ...
    auto textMuted = ImColor(140, 140, 140, 255);

    auto borderLight = ImColor(52, 61, 74, 255);
    auto borderMedium = ImColor(42, 51, 64, 255);
    auto borderDark = ImColor(22, 27, 34, 255);
...
void set_modern_purple_theme()
{
    ...
    auto backgroundDarkest = ImColor(20, 15, 25, 255);
    auto backgroundDark = ImColor(28, 22, 35, 255);
    auto backgroundMedium = ImColor(38, 30, 48, 255);
    auto backgroundLight = ImColor(48, 38, 58, 255);
    auto backgroundPopup = ImColor(25, 20, 30, 255);

    auto primaryAccent = ImColor(147, 112, 219, 255);
    ...
    auto secondaryAccent = ImColor(255, 182, 193, 255);
...
void set_warm_amber_theme()
{
    ...
    auto backgroundDarkest = ImColor(25, 20, 15, 255);
    auto backgroundDark = ImColor(35, 28, 20, 255);
    auto backgroundMedium = ImColor(45, 35, 25, 255);
    auto backgroundLight = ImColor(55, 43, 30, 255);
    auto backgroundPopup = ImColor(30, 24, 18, 255);

    auto primaryAccent = ImColor(255, 165, 0, 255);
    ...
    auto secondaryAccent = ImColor(255, 215, 0, 255);
...
void set_cool_blue_theme()
{
    ...
    auto backgroundDarkest = ImColor(15, 20, 30, 255);
    auto backgroundDark = ImColor(20, 28, 40, 255);
    auto backgroundMedium = ImColor(25, 35, 50, 255);
    auto backgroundLight = ImColor(30, 43, 60, 255);
    auto backgroundPopup = ImColor(18, 25, 35, 255);

    auto primaryAccent = ImColor(0, 174, 239, 255);
    ...
    auto secondaryAccent = ImColor(64, 224, 255, 255);
...
void set_minimalist_green_theme()
{
    ...
    auto backgroundDarkest = ImColor(18, 20, 18, 255);
    auto backgroundDark = ImColor(26, 28, 26, 255);
    auto backgroundMedium = ImColor(34, 36, 34, 255);
    auto backgroundLight = ImColor(42, 44, 42, 255);
    auto backgroundPopup = ImColor(22, 24, 22, 255);

    auto primaryAccent = ImColor(76, 175, 80, 255);
    ...
    auto secondaryAccent = ImColor(129, 199, 132, 255);
