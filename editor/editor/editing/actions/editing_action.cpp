...
void editing_action_t::draw_in_inspector_impl(rtti::context& ctx, const entt::meta_any& old_value, const entt::meta_any& new_value, const entt::meta_custom& custom)
{
    ...
    auto child_name = fmt::format("##tooltip_child_{}_{}", name, uintptr_t(this));
    ImGui::BeginChild(child_name.c_str(), {}, ImGuiChildFlags_AlwaysAutoResize | ImGuiChildFlags_AutoResizeX | ImGuiChildFlags_AutoResizeY);
    ...
    auto child_name2 = fmt::format("##tooltip_child2_{}_{}", name, uintptr_t(this));
    ImGui::BeginChild(child_name2.c_str(), {}, ImGuiChildFlags_AlwaysAutoResize | ImGuiChildFlags_AutoResizeX | ImGuiChildFlags_AutoResizeY);
