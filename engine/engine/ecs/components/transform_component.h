...
struct active_component : public component_crtp<root_component>
{
};
...
public:
    ...
    auto set_position_and_rotation_global(const math::vec3& position,
...
private:
    ...
    void on_flags_changed(flags_t flags);
    auto get_flags_global() const noexcept -> flags_t;
    /**
