...
#define GI_SCREEN_PROBE_RAYS_PER_FRAME  16
#define GI_SCREEN_PROBE_WINDOW          4
#define GI_SCREEN_PROBE_HISTORY_TILE    0.25
#define GI_SCREEN_PROBE_WALK_WINDOWS    1
...
#define GI_REFLECTION_MESH_SDF_RANGE_SHARP   40.0
