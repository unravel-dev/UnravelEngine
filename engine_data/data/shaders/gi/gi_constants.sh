...
#define GI_MESH_SDF_TRACE_RANGE         8.0
#define GI_SCREEN_PROBE_SHORT_RANGE     8.0
#define GI_RELIGHT_SHADOW_NEAR_FIELD    2.0
#define GI_WORLD_PROBE_MESH_RANGE       20.0
...
#define GI_WORLD_PROBE_RELOCATE_REFRESH_FRAMES 16
#define GI_WORLD_PROBE_CONVOLVE_PERIOD  4
