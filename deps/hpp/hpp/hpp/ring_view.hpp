...
public:
    ...
    reference operator[](std::ptrdiff_t idx) noexcept;
    const_reference operator[](std::ptrdiff_t idx) const noexcept;
...
template <typename T, class Popper>
typename hpp::ring_span<T, Popper>::reference hpp::ring_span<T, Popper>::operator[](std::ptrdiff_t i) noexcept
{
    return at(i);
}

template <typename T, class Popper>
typename hpp::ring_span<T, Popper>::const_reference hpp::ring_span<T, Popper>::operator[](std::ptrdiff_t i) const noexcept
{
    return at(i);
}
