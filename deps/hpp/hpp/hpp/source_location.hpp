...
#if defined(__has_include) && !defined(STX_NO_STD_SOURCE_LOCATION)
#if __has_include(<source_location>) && (__cplusplus >= 202002)
#include <source_location>
#define STX_HAVE_STD_SOURCE_LOCATION 1
#endif
#endif

namespace hpp
{
#ifdef STX_HAVE_STD_SOURCE_LOCATION
